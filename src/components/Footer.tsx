        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://x.com/promptTostartup" className="text-gray-400 hover:text-blue-600 transition-colors">
                <Twitter className="w-5 h-5" />
              </a>
              <a href="https://www.linkedin.com/company/promptto" className="text-gray-400 hover:text-blue-600 transition-colors">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="https://github.com/PromptTo" className="text-gray-400 hover:text-blue-600 transition-colors">
        ...
        <div className="border-t border-gray-200 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-600">
              © 2025 PromptTo AI Lab. All rights reserved.
            </p>
