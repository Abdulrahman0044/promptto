...
import { ExternalLink, Github, Calendar, Users, Cpu, Database, Globe } from 'lucide-react';
...
const Projects = () => {
  const projects = [
    {
      ...
      description: "IoT-powered farm monitoring system with real-time data analytics, automated irrigation, and crop health assessment using AI. Deployed across multiple farms in Nigeria with 40% increased crop yield.",
      image: "agriculture",
      icon: Cpu,
    ...
    },
    {
      ...
      description: "Next-generation AI platform for creative professionals and businesses. Features advanced prompt engineering, model training capabilities, and collaborative AI workflows.",
      image: "ai",
      icon: Database,
    ...
    },
    {
      ...
      description: "Comprehensive aquaculture management system with water quality monitoring, feeding automation, and fish health analytics. Optimizes fish farming operations.",
      image: "aquaculture",
      icon: Database,
  ...
  const getGradientClass = (image: string) => {
    ...
    return gradients[image as keyof typeof gradients] || 'from-blue-400 to-blue-600';
  };
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Real-world applications of our technology solutions driving impact across industries in Nigeria and beyond.
          </p>
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full">AI & Machine Learning</span>
            <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full">IoT Solutions</span>
            <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full">Web Development</span>
            <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full">Data Analytics</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project) => {
              ...
              return (
                <div key={project.id} className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-all transform hover:-translate-y-2">
                  {/* Project Image/Icon */}
                  <div className={`h-48 bg-gradient-to-br ${getGradientClass(project.image)} flex items-center justify-center relative`}>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Measurable results from our technology solutions</p>
          </div>
